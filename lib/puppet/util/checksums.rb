...
module Puppet::Util::Checksums
  ...
  def known_checksum_types
    [:sha256, :sha256lite, :md5, :md5lite, :sha384, :sha384lite, :sha512, :sha512lite, :sha1, :sha1lite,
      :mtime, :ctime, :none]
  end
  ...
  def sha512lite(content)
    sha512(content[0..511])
  end

  def sha512lite?(string)
    sha512?(string)
  end

  def sha512lite_file(filename)
    sha512_file(filename, true)
  end

  def sha512lite_stream(&block)
    sha512_stream(true, &block)
  end

  def sha512lite_hex_length
    sha512_hex_length
  end
