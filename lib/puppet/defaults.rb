...
EOT
    ...
    :digest_algorithm => {
        :default  => 'md5',
        :type     => :enum,
        :values => ["md5", "sha256", "sha384"],
        :desc     => 'Which digest algorithm to use for file resources and the filebucket.
                      Valid values are md5, sha256, sha384. Default is md5.',
    },
    :supported_checksum_types => {
      :default => ['md5', 'sha256', 'sha384'],
      :type    => :array,
      :desc    => 'Checksum types supported by this agent for use in file resources of a
                   ...
                   md5lite, sha256, sha256lite, sha384, sha384lite, sha1, sha1lite, mtime, ctime.',
      :hook    => proc do |value|
        values = munge(value)
        valid   = ['md5', 'md5lite', 'sha256', 'sha256lite', 'sha384', 'sha384lite', 'sha1', 'sha1lite', 'mtime', 'ctime']
